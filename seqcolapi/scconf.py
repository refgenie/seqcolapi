...
class SeqColConf(yacman.YacAttMap):
    def __init__(self, entries={}, filepath=None, yamldata=None, writable=False,
        wait_max=60, skip_read_lock=False):        
        super(SeqColConf, self).__init__(
            entries, filepath, yamldata, writable)
...
class RDBDict(object):
    ...
    """
    def __init__(self, db_name, db_user, db_password, db_host, db_port, db_table="seqcol"):
        self.db_table = db_table
        self.db_name = db_name
        self.db_user = db_user
        self.db_host = db_host
        self.db_port = db_port
        self.connection = self.create_connection(db_name, db_user, 
